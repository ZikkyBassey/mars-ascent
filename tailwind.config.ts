    ...
    extend: {
      ...
      keyframes: {
        ...
        "exhaust-flicker": {
          ...
          "25%": { transform: "scaleX(1.15) scaleY(1.1)", opacity: "1" },
          "50%": { transform: "scaleX(0.85) scaleY(0.95)", opacity: "0.7" },
          "75%": { transform: "scaleX(1.1) scaleY(1.05)", opacity: "0.95" },
        },
        "glitch-shift": {
          "0%, 100%": { clipPath: "inset(0 0 100% 0)", transform: "translate(0)" },
          "10%": { clipPath: "inset(10% 0 60% 0)", transform: "translate(-4px, 2px)" },
          "20%": { clipPath: "inset(50% 0 30% 0)", transform: "translate(4px, -2px)" },
          "30%": { clipPath: "inset(80% 0 5% 0)", transform: "translate(-3px, 1px)" },
          "40%": { clipPath: "inset(0 0 100% 0)", transform: "translate(0)" },
        },
      },
      animation: {
        ...
        "meteor": "meteor 1.2s ease-out",
        "exhaust-flicker": "exhaust-flicker 0.4s ease-in-out infinite",
        "glitch-shift": "glitch-shift 4s steps(1) infinite",
      },
    },
  },
