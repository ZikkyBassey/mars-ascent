    ...
    <div className="container relative z-10 grid lg:grid-cols-2 gap-16 items-center">
      ...
      <div className="relative">
        <div className="glass-panel rounded-3xl p-8 md:p-10 relative overflow-hidden">
          <div className="absolute -top-20 -right-20 w-60 h-60 rounded-full bg-mars-crimson/30 blur-3xl" />
          <div className="grid grid-cols-2 gap-6 relative">
            {[
              ...
              <div key={s.k} className="border border-mars-crimson/20 rounded-xl p-5 bg-mars-black/40">
